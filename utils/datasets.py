...
def Get_Dataset(experiment, approach):
    ...
    if experiment == 'pa100k':
        ...
        train_dataset = MultiLabelDataset(root='/workspace/dataset/train_images/',
                    label='/workspace/dataset/train_dataset.txt', transform=transform_train)
        val_dataset = MultiLabelDataset(root='/workspace/dataset/val_images/',
                    label='/workspace/dataset/val_dataset.txt', transform=transform_test)
        test_dataset = MultiLabelDataset(root='/workspace/dataset/test_images/',
                    label='/workspace/dataset/test_dataset.txt', transform=transform_test)
        return train_dataset, val_dataset, test_dataset, attr_nums['foottraffic'], description['foottraffic']
